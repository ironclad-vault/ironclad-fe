  ...
  return (
    <div ref={stepRef} className="relative group">
      ...
      <div className="hidden md:block h-full">
        <div className="card-pro p-8 text-center flex flex-col h-full hover:border-accent transition-all duration-500 hover:scale-105 hover:-translate-y-2 relative hover-lift">
          ...
          {/* Step Number */}
          <div className="text-heading text-5xl md:text-6xl mb-4 text-accent group-hover:scale-110 transition-transform duration-300 relative z-10">
            {step.number}
          </div>

          {/* Step Title */}
          <div className="text-heading text-2xl mb-4 group-hover:text-accent transition-colors duration-300 relative z-10">
            {step.title}
          </div>
      ...
      <div className="md:hidden">
        <div className="relative flex">
          ...
          <div className="flex flex-col items-center mr-6">
            {/* Node */}
            <div className="w-6 h-6 bg-accent border-4 border-white rounded-full z-20 timeline-node" />
          ...
          <div className="flex-1 card-pro p-6 text-left flex flex-col hover:border-accent transition-all duration-300 hover:scale-102 pb-6 mb-4">
            ...
            {/* Step Number */}
            <div className="text-heading text-3xl mb-2 text-accent">
              {step.number}
            </div>

            {/* Step Title */}
            <div className="text-heading text-lg mb-3 group-hover:text-accent transition-colors duration-300">
              {step.title}
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 h-full relative z-10">
        {/* Section Title */}
        <div ref={titleRef} className="text-center mb-20 card-pro border-accent py-12 px-6">
