...
export function TransactionProofCard({
  ...
  if (loading) {
    return (
      <div className={`card-brutal p-6 bg-gray-50 ${className}`}>
  ...
  if (error) {
    return (
      <div className={`card-brutal p-6 bg-gray-50 border-gray-300 ${className}`}>
        <div className="flex justify-between items-start mb-2">
          <h4 className="heading-brutal text-sm font-bold text-gray-700">
        ...
        <p className="body-brutal text-xs text-gray-500">{error}</p>
      </div>
    );
  }
  ...
  return (
    <div className={`card-brutal p-6 ${className}`}>
      <div className="flex justify-between items-start mb-4">
        <h4 className="heading-brutal text-sm font-bold">
          {proofTypeLabel} PROOF
        </h4>
        <span
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={copyTxid}
              className="button-brutal py-1 px-2 text-xs whitespace-nowrap"
